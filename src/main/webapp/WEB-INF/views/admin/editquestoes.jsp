...
<script type="text/javascript" src="/amcequiz/assets/mathjax/MathJax.js?config=TeX-AMS-MML_HTMLorMML"></script>
...
function salvarQuestao(procedimento, args) {
	...
	$.ajax({
		type : "POST",
		url : "/amcequiz/admin/savequestao",
		data : questao,
		success : function() {
...
function removerQuestao(qnum) {
	...
	$.ajax({
		type : "POST",
		url : "/amcequiz/admin/deletequestao",
		data : "qnum="+qnum,
		success : function() {
			gotoQuestoes();
		},
...
function novaAlternativa() {
	$.ajax({
		type : "POST",
		url : "/amcequiz/admin/newalternativa",
		success : function() {
			gotoQuestoes();
		},
		error : function(e) {
...
function removerAlternativa(letra) {
	...
	$.ajax({
		type : "POST",
		url : "/amcequiz/admin/deletealternativa",
		data : "letra="+letra,
		success : function() {
			gotoQuestoes();
		},
